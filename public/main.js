class Game extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("red1", "flappyBird/red1.png");
    this.load.image("red2", "flappyBird/red2.png");
  ...
  addBackground() {
    this.gameBg = this.add.tileSprite(0, 600, 1800, 1200, "background");
  ...
  spawn() {
    ...
    this.time.delayedCall(4000, this.spawn, [], this);
  }
  ...
  spawnPipes(x, y) {
    ...
    const pipeTop = this.pipes
      .create(x, y - sy - 400, "yellow2")
      .setScale(0.35);
    const pipeBottom = this.pipes.create(x, y, "yellow1").setScale(0.35);
